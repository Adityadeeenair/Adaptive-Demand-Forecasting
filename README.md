...
1. Data preprocessing prepares the dataset by converting date fields and generating unique product identifiers.

2. Demand behavior analysis calculates statistical metrics such as trend, volatility, intermittency, and seasonality.

3. Product segmentation categorizes products based on their demand patterns.

4. Classical forecasting models are applied to segments where statistical approaches perform well.

5. Machine learning feature engineering converts the time series into supervised learning features.

6. Machine learning models are trained using a global forecasting approach.

7. Model predictions are combined through an ensemble method to produce the final forecast.
...
Step 1 : Clone the repository -
         git clone https://github.com/YOUR_USERNAME/adaptive-demand-forecasting.git
